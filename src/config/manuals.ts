...
const stepsEn: ManualStep[] = [
  ...
  },
  {
    ...
    callouts: [
      {
        title: 'Week window',
        text: 'Check the active days and move through the planning week.',
        x: 50,
        y: 18,
      },
      {
        title: 'Schedule chips',
        text: 'Tasks and usage entries appear as practical planning items.',
        x: 50,
        y: 48,
      },
    ],
...
const stepsPl: ManualStep[] = [
  ...
  },
  {
    ...
    callouts: [
      {
        title: 'Okno tygodnia',
        text: 'Sprawdź aktywne dni i poruszaj się po tygodniu planowania.',
        x: 50,
        y: 18,
      },
      {
        title: 'Elementy harmonogramu',
        text: 'Zadania i użycie pojawiają się jako praktyczne pozycje planu.',
        x: 50,
        y: 48,
      },
    ],
